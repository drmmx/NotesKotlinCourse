...
import com.drmmx.notes.navigation.NavigationActivity.Companion.FRAGMENT_TYPE_KEY
import com.drmmx.notes.navigation.NavigationActivity.Companion.FRAGMENT_VALUE_NOTE
import com.drmmx.notes.navigation.NavigationActivity.Companion.FRAGMENT_VALUE_TASK
...
class CreateActivity : AppCompatActivity(), CreateNoteFragment.OnFragmentInteractionListener, CreateTaskFragment.OnFragmentInteractionListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        intent?.getStringExtra(FRAGMENT_TYPE_KEY).run {
            when {
                this == FRAGMENT_VALUE_TASK -> createFragment(CreateTaskFragment.newInstance())
                this == FRAGMENT_VALUE_NOTE -> createFragment(CreateNoteFragment.newInstance())
            }
        }
    }
